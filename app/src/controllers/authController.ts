...
export async function loginUser(req: Request, res: Response) {
    ...
    try {
        ...
        const authToken = jwt.sign(jwtPayload, process.env.SECRET as string, { expiresIn: '1h' })

        return res.cookie('authToken', authToken, { sameSite: 'strict', httpOnly: true, secure: true, maxAge: 3600000 }).json({
